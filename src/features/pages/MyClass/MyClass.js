...
import {selectCurrentClass,putAttendance,takeAttendance} from '../../slices/dataSlice';
...
function MyClass() {
  ...
  return (
    ...
    <button className='btn in-line' onClick={()=>navigate('/edit-class-details')}>edit class</button>
